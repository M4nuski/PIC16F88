...
; Ultrasonic meter HC-SR04 Module
; Version 01
; Internal 8MHz OSC 2MOPS 0.5us per ops
; TMR1 max 0.032786s = 11m
...
#define	LCD_CLK		PORTA, 2
#define	LCD_DATA	PORTA, 3

; PORTA4 I/O AN4 T0CKI C2Out
; PORTA5 In  #MCLR Vpp
; PORTA6 Out OSC2 CLKO			Trig
; PORTA7 In  OSC1 CLKI			Echo
#define USM_Trig	PORTA, 6
#define USM_Echo	PORTA, 7

; PORTB0 I/O INT CPP1
; PORTB1 I/O SDI SDA
; PORTB2 I/O SDO RX DT
; PORTB3 I/O PGM CCP1

; PORTB4 I/O SCK SCL
; PORTB5 I/O SS TX CK
; PORTB6 I/O AN5 PGC T1OSO T1CKI
; PORTB7 I/O AN6 PGD T1OSI
