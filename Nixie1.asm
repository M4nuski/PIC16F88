...
; Shared mem
serialBuf_rp	EQU	serialBufStart ; circular buffer read pointer
serialBuf_wp	EQU	serialBufStart ; circular buffer write pointer
...
;	CLRF	TMR1H
	...
	CALL	SEND_BYTE	; send the byte back
