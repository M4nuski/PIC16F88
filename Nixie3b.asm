...
;	3a: binary to grey code mode input
;	3b: fixed negative altitude hang
;#############################################################################
...
#DEFINE	CONV_DOT		'.' - '0'; ascii dot converted to byte
#DEFINE	CONV_MINUS		'-' - '0'; ascii minus converted to byte
...
; v 3a
; first switch is mode b0
; second switch is mode b1
; grey code cam
; <--- Sec First <--- Off Switch
; sF sf Sf SF
; 01 00 10 11
_mode_Time				EQU	3 ; was 0, first switch is mode1 second
_mode_Alt				EQU	2 ; was 1
_mode_Lat				EQU	0 ; was 2
_mode_Long				EQU	1 ; was 3
...
startUpMessage:
	WRITESTRING_LN		"Nixie 3b - Time + Alt + Lat + Long"
