...
;#############################################################################
	...
	__CONFIG	_CONFIG1, _CP_OFF & _CCP1_RB0 & _DEBUG_OFF & _WRT_PROTECT_OFF & _CPD_OFF & _LVP_OFF & _BODEN_OFF & _MCLR_OFF & _PWRTE_ON & _WDT_OFF &_INTRC_IO; _INTRC_IO;_EXTCLK
...
#DEFINE _TFT_A0	        PORTB, 1 ; register select Data/#Cmd  A0 command:0, data:1
