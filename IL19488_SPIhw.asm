...
;#############################################################################
; hardware SPI version, async, no interrupt
...
TFT_SEND_CMD:	; send command in W
	...
	BSF     PIN_TFT_CS
	BSF     PIN_TFT_A0 ; DC is 0 for commands
...
SetCharAddress:
	;CLRF	Npos+1
	;MOVLW	6*4-1 ; 1/2 of screen width
	;MOVWF	Npos
	;ADDsFast Npos, Xpos
...
DrawBin4Char: ; Send 4x4 binned char data for 8x6 in CharData
	;MOVLW	_TFT_RAMCONT
	;CALL	TFT_SEND_CMD
