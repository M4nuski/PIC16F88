...
; pin 16 I_X PORTA7	I DRO1 Clock
...
#DEFINE pin_DRO0_DATA		PORTA, 0
mask_DRO0_DATA		EQU	0x01
#DEFINE pin_DRO0_CLOCK	PORTA, 1
mask_DRO0_CLOCK	EQU	0x02
#DEFINE pin_DRO1_DATA		PORTA, 3
mask_DRO1_DATA		EQU	0x08
#DEFINE pin_DRO1_CLOCK	PORTA, 7
mask_DRO1_CLOCK	EQU	0x80

#DEFINE pin_KEYPAD_CLOCK	PORTA, 4
;#DEFINE MCLR			PORTA, 5
#DEFINE pin_KEYPAD_OUTPUT	PORTA, 6
#DEFINE pin_KEYPAD_INPUT	PORTA, 2

#DEFINE pin_Disp0_DATA	PORTB, 0
#DEFINE pin_Disp_CLOCK	PORTB, 1
