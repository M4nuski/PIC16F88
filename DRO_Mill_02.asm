...
;CFG_bitDia0		EQU	0 ; X2 for radius to dia ; removed for MILL
;CFG_bitDia1		EQU	1
;CFG_bitDia2		EQU	2
;CFG_bitDia		EQU	3 ; current for selected dro
CFG_bitReverse0		EQU	4
CFG_bitReverse1		EQU	5
CFG_bitReverse2		EQU	6
CFG_bitReverse		EQU	7 ; current for selected dro
...
ACQ_DRO0:
	...
	; BCF	CFG, CFG_bitDia ; removed for MILL
	; BTFSC	CFG, CFG_bitDia0
	; BSF	CFG, CFG_bitDia	
	BCF	CFG, CFG_bitReverse
	BTFSC	CFG, CFG_bitReverse0
	BSF	CFG, CFG_bitReverse
	
	CALL	ACQ_DRO
	
	;;;DEBUG;;BW_False	DRO0_done
	MOVc	data_0, dro0_0	
...
ACQ_DRO1:
	...
	; BCF	CFG, CFG_bitDia ; removed for MILL
	; BTFSC	CFG, CFG_bitDia1
	; BSF	CFG, CFG_bitDia	
	BCF	CFG, CFG_bitReverse
	BTFSC	CFG, CFG_bitReverse1
	BSF	CFG, CFG_bitReverse
	
	CALL	ACQ_DRO
	
	;debug;;BW_False	DRO1_done
	MOVc	data_0, dro1_0	
...
ACQ_DRO2:
	...
	; BCF	CFG, CFG_bitDia ; removed for MILL
	; BTFSC	CFG, CFG_bitDia2
	; BSF	CFG, CFG_bitDia	
	BCF	CFG, CFG_bitReverse
	BTFSC	CFG, CFG_bitReverse2
	BSF	CFG, CFG_bitReverse
	
	CALL	ACQ_DRO
	
	;;;debug;;BW_False	DRO2_done
	MOVc	data_0, dro2_0	
...
DRO_noReverse:	
	...
	RETLW	TRUE; GOTO	DRO_notNegative	; removed for MILL
	
	BCF	data_2, data_signBit ; clear old bit
	NEGc	data_0	; 2's complement
	
	RETLW	TRUE
; DRO_notNegative: ; removed for MILL
	; ; apply config
	; dia not used for MILL
	; BTFSS	CFG, CFG_bitDia
	; RETLW	TRUE
